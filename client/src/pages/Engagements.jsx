...
export default function Engagements() {
  return (
    <div className='min-h-screen bg-white dark:bg-[rgb(16,23,42)] w-full pt-20'>
      <div className='flex flex-col items-center justify-center py-10 px-4 lg:px-6 max-w-5xl gap-8 mx-auto'>
        ...
        <div className='flex flex-col items-center gap-4'>
          <a href='mailto:sixtusushrey@gmail.com' className='btn btn-primary'>Reach Out</a>  {/* Contact Me button */}
